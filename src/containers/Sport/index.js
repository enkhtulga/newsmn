  ...
  return (
    <Box>
      <Box className={classes.breadcrumbsWrap}>
        <NBreadcrumbs className="module__content" title={"Спорт мэдээ"} />
      </Box>
      <section>
        <Box pt={10} pb={10} pl={20} pr={20} mb={9} className={classes.blackBg}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={3}>
          <StickySidebar offsetTop={16} offsetBottom={16}>
            ...
            />
            <NBanner src="/banner_sport_sidebar.jpg" width={330} height={299} />
          </StickySidebar>
        </Grid>
        <Grid item xs={6}>
          <NPageMenu
