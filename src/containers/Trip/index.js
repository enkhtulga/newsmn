      ...
      <Box className="module__content">
        <Grid container spacing={2}>
          ...
          >
            ...
            <StickySidebar offsetTop={16} offsetBottom={16}>
              <Box
                ...
                className={classes.stickySocial}
              >
                <NSocialVertical />
              </Box>
            </StickySidebar>
          ...
          <Grid item xs={12} sm={12} md={8}>
            ...
            <Typography variant="body2" className={classes.content}>
              Энэхүү цогцолбор нь Улаанбаатар хотоос 53 км зайд байгалийн сайхан
              цогцолсон Туул голын ойролцоо Төв аймгийн Эрдэнэ сумын нутаг
              “Цонжин болдог” хэмээх түүхэн үйл явдалтай холбоотой газарт
              байрладаг. Монгол орны ихэнх түүх соёлын дурсгалт болон байгалийн
              үзэсгэлэнт газруудад хүрэхийн тулд замын хүнд нөхцөлд 300-аас дээш
              км замыг туулж байж хүрдэгтэй харьцуулахад энэ нь маш том давуу
              тал юм.
            </Typography>
            <NTopCarousel
              slidesPerView={1}
            ...
            <NTripItem title="Тэмээ үзэх аялал" image="/trip_item_img_2.jpg" />
            <NTripItem
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={12} lg={10}>
            <Box mt={4} mb={4}>
              <NBanner src="/banner_trip_middle.jpg" width={1140} />
            </Box>
          </Grid>
          <Grid item xs={12} md={12} lg={1}></Grid>
        </Grid>
